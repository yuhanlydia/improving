...
| Method | Round-5 pass@1 | 95% CI | Correct AST coverage @4 | Eligible tasks |
| --- | ---: | --- | ---: | ---: |
...
At round 5, spectral-soft retained more correct-program AST coverage than plain and SPD-hard in point estimates. Its paired coverage advantage over SPD-hard was +0.293 [0.233, 0.353] on 251 shared eligible tasks. Pass@1 was 0.402 versus 0.413 for both controls. The paired pass@1 delta versus SPD-hard was -0.0118 [-0.0190, -0.0048], so the declared 1% noninferiority criterion was not met. Spectral-soft remained above the base model in pass@1 (+0.0225 [0.0120, 0.0335]) while all methods lost diversity relative to base across five rounds.
